...
namespace PRESTEP\EventRegistrationBundle\ContaoManager;


use PRESTEP\EventRegistrationBundle\PRESTEPEventRegistrationBundle;
...
class Plugin implements BundlePluginInterface, ConfigPluginInterface, DependentPluginInterface
{
    ...
    public function getBundles(ParserInterface $parser)
    {
        ...
        return [
            BundleConfig::create(PRESTEPEventRegistrationBundle::class)
                ...
                [
                    ...
                    [
                        ...
                        [
                            'mappings' =>
                            [
                                'PRESTEPEventRegistrationBundle' => ''
                            ]
                        ]
                    ]
                ]
