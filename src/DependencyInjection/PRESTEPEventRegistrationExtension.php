...
namespace PRESTEP\EventRegistrationBundle\DependencyInjection;
 ...
 */
class PRESTEPEventRegistrationExtension extends Extension implements PrependExtensionInterface
{
    /**
     * {@inheritdoc}
     *
